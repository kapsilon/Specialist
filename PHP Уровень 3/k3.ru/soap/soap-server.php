...
/*
$test = new newsService();
//echo unserialize(base64_decode($test->getNewsById(9)));

print_r(unserialize(base64_decode($test->getNewsById(9))));
*/


ini_set("soap.wsdl_cache_enabled", "0");
$server = new SoapServer("http://k3/soap/news.wsdl");
